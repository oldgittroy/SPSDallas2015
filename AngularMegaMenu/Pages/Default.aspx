...
<asp:Content ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
	...
	<script type="text/javascript" src="../Scripts/app/MenuController.js"></script>
	<script type="text/javascript" src="../Scripts/app/MenuDirective.js"></script>
...
<asp:Content ContentPlaceHolderID="PlaceHolderMain" runat="server">
	...
	<div id='content' ng-app='MegaMenuApp' ng-controller='MainController'>
		{{status}}
