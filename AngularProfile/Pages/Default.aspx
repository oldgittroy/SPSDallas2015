...
<asp:Content ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
	...
	<script src="../Scripts/app/UrlService.js" type="text/javascript"></script>
	<script src="../Scripts/app/ProfileService.js" type="text/javascript"></script>
</asp:Content>
...
<asp:Content ContentPlaceHolderID="PlaceHolderMain" runat="server">
	...
	<div id='content' ng-app='App' ng-controller='MainController3'>
		{{status}}
	</div>
